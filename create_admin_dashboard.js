...
const enhancedAdminDashboard = `import React, { useState, useEffect } from 'react';
...
fs.writeFileSync('D:/website/testing/frontend/src/pages/admin/AdminDashboard.tsx', enhancedAdminDashboard);
console.log('Enhanced AdminDashboard.tsx created successfully!');