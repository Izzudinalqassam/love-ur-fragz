...
const enhancedAdminPerfumes = `import React, { useState, useEffect } from 'react';
import {
  Card,
  CardContent,
  Button,
...
fs.writeFileSync('D:/website/testing/frontend/src/pages/admin/AdminPerfumes.tsx', enhancedAdminPerfumes);
console.log('Enhanced AdminPerfumes.tsx created successfully!');